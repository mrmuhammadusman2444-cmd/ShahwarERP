...
import MainCategoryPopup from './MainCategoryPopup.jsx';
    ...
    return (
        ...
        <div className="p-4 md:p-5">
          
          {
            showPopup==true
            ?
            <MainCategoryPopup setShowPopup={setShowPopup}/>
            :
            null
          }
            ...
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-gray-800 text-lg font-bold">Category</h1>
                        <p className="text-gray-400 text-xs">Main Category</p>
                    </div>
                </div>
            ...
            <div className="flex flex-wrap gap-2 mb-4">
                ...
                <button onClick={()=>{setShowPopup(true)}}  className="flex items-center cursor-pointer gap-2 px-4 py-2 bg-white hover:bg-emerald-50 border border-emerald-200 text-emerald-700 text-sm font-semibold rounded-xl transition-all hover:-translate-y-0.5">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <thead>
                            <tr className="bg-emerald-600 text-white">
                                <th className="text-center text-xs font-semibold px-6 py-3 w-full">
                                    <div className="flex items-center justify-center -ml-190 gap-1">
                                        Category Name
                                        <svg className="w-3 h-3 opacity-70 cursor-pointer" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="flex items-center -ml-280 justify-center mt-2 ">
                                    Order No
                                    <svg className="w-3 h-3 opacity-70 cursor-pointer"  fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16V4m0 0L3 8m4-4l4 4M17 8v12m0 0l4-4m-4 4l-4-4" />
                                    </svg>
                                ...
                                <th className="text-center text-xs font-semibold px-6 py-3 whitespace-nowrap">
                                    <div className="flex items-center justify-center gap-1 -ml-80">
                                        Action
                                        <svg className="w-3 h-3 cursor-pointer opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            {MainCategory.length === 0 ? (
                                <tr>
                                    <td colSpan={2} className="text-center py-16">
                                        <div className="flex flex-col items-center gap-2">
                                            ...
                                            <p className="text-gray-400 text-sm">No Main Category Found</p>
                                            <p className="text-gray-300 text-xs">Add Some Main Category</p>
                                        </div>
                                    </td>
                                </tr>
                            ) : (
                                MainCategory.map((cat, idx) => (
                                    <tr key={cat.id}
                                        ...
                                        <td className="px-6 py-3 text-center text-emerald-500 text-sm">
                                            {cat.name}
                                        </td>
                                        <td className="px-6 py-3">
                                            <div className="flex items-center justify-center gap-1.5">
                                                <button className="w-7 h-7 bg-emerald-400 hover:bg-emerald-500 rounded flex items-center justify-center transition-colors" title="Edit">
