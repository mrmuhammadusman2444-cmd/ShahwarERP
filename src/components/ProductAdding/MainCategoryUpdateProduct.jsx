...
const MianCategoryUpdateProdcut = ({ value, onChange }) => {
    ...
    return (
        <div ref={ref} className="relative ">
            ...
            {open && (
                <div className="absolute top-[calc(100%+6px)] left-0 z-50  bg-white border border-emerald-100 rounded-2xl shadow-lg shadow-emerald-100/50 w-65">
...
export default MianCategoryUpdateProdcut;