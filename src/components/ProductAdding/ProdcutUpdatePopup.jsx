...
const ProdcutUpdatePopup = ({ setShowProductPopup, updateData, handleManageProdcut }) => {
    ...
    async function handleUpdateProduct() {
        ...
        try {
            ...
            await axios.post(`http://localhost:3000/update/product/${updateData._id}`, formData, {
                ...
                <div className="max-h-[calc(92vh-9.5rem)] overflow-y-auto px-7 py-6">
                    ...
                    <div className="grid grid-cols-1 gap-x-10 gap-y-8 xl:grid-cols-2">
                        ...
                        <section>
                            ...
                            <div className="group col-span-2">
                                <label className="mb-1.5 block text-[11px] font-semibold uppercase tracking-wide text-gray-500">Product picture</label>
                                <div className="relative flex h-24 items-center justify-center gap-3 overflow-hidden rounded-xl border-2 border-dashed border-emerald-200 bg-emerald-50/40 transition-all duration-200 hover:border-emerald-400 hover:bg-emerald-50">
                                    <input
                                        onChange={(e) => {
                                            const file = e.target.files[0]
                                            if (file) setProduct({ ...product, picture: file })
                                        }}
                                        type="file"
                                        accept="image/*"
                                    ...
                                    {product.picture ? (
                                        ...
                                        <>
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-0.5 text-xs text-gray-400">PNG, JPG — max 5MB</p>
                                            </div>
                                        </>
                                    )}
                                </div>
