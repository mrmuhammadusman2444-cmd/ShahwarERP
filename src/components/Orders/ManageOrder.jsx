    ...
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-white to-blue-50 p-4 md:p-6">
      ...
      {detailOrder && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-emerald-950/40 backdrop-blur-sm p-4" onClick={() => setDetailOrder(null)}>
          <div className="relative w-full max-w-3xl max-h-[90vh] overflow-hidden rounded-3xl bg-white shadow-2xl ring-1 ring-emerald-100 flex flex-col" onClick={(e) => e.stopPropagation()}>

            <div className="flex items-center justify-between gap-4 border-b border-emerald-100 bg-linear-to-r from-emerald-600 to-emerald-700 px-6 py-4">
            ...
            <div className="flex items-center justify-between gap-4 border-t border-emerald-100 bg-emerald-50/40 px-6 py-4">
              <div className="flex items-center gap-2">
                <span className="text-gray-400 text-[10px] font-semibold uppercase tracking-wide">Weight</span>
