      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-400 text-xs">Cash Book</p>
          </div>
        </div>
      ...
      <div className="bg-white border border-emerald-100 rounded-2xl shadow-sm p-5 mb-4">
        <div className="flex flex-wrap items-end gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input type="date" defaultValue="2026-07-01" className="bg-emerald-50 border border-emerald-100 focus:border-emerald-400 focus:bg-white rounded-xl px-3 py-2.5 text-gray-700 text-sm focus:outline-none transition-all cursor-pointer w-40" />
          </div>
