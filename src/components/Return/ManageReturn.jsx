    ...
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-white to-blue-50 p-4 md:p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          <div className="w-10 h-10 rounded-2xl bg-linear-to-b from-emerald-500 to-emerald-700 flex items-center justify-center shadow-md shadow-blue-200">
          ...
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="bg-linear-to-b from-emerald-500 to-emerald-700 text-white">
                ...
                <th className="text-left text-xs font-semibold px-4 py-3 whitespace-nowrap">Return No</th>
              ...
              {sales.length === 0 ? (
                <tr>
                  <td colSpan={7} className="text-center py-16">
                    <div className="flex flex-col items-center gap-2 ml-10 mt-10">
                      ...
                      <p className="text-gray-400 text-sm">No return records found</p>
                      <p className="text-gray-300 text-xs">Add some return records</p>
                    </div>
                  </td>
                </tr>
              ) : (
                sales.map((sale, idx) => (
                  <tr key={sale.id} className={`hover:bg-blue-50/40 transition-colors ${idx % 2 === 0 ? "bg-white" : "bg-gray-50/30"}`}>
                    ...
                    <td className="px-4 py-3 text-blue-500 text-xs">{sale.saleBy}</td>
                    <td className="px-4 py-3 text-blue-500 text-xs">{sale.customerName}</td>
                    <td className="px-4 py-3 text-gray-600 text-xs whitespace-nowrap">{sale.date}</td>
                    <td className="px-4 py-3 text-gray-700 text-xs font-medium">{sale.totalAmount}</td>
