          ...
          <div className="bg-white border border-emerald-100 rounded-2xl shadow-sm p-4 flex flex-col flex-1">
            ...
            <div className="grid grid-cols-3 gap-3 overflow-y-auto flex-1 max-h-[62vh] pr-1 custom-scroll">
              {Return.map((p) => (
                <div
                  key={p.id}
                  className="group bg-white hover:bg-emerald-100 border border-emerald-100 hover:border-emerald-300 rounded-xl p-3 cursor-pointer transition-all duration-200 hover:shadow-md hover:shadow-emerald-100 hover:-translate-y-0.5 h-fit"
                >
        ...
        <div className="flex-1 min-w-0 flex flex-col gap-3">
          ...
          <div className="bg-white border border-blue-100 rounded-2xl shadow-sm p-5">
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <h2 className="text-gray-800 text-sm font-semibold">Return Details</h2>
                <p className="text-gray-400 text-xs">Fill in the information below</p>
              </div>
            </div>
            <div className="grid grid-cols-3 gap-3 mb-4">
              <div>
                <label className="text-gray-700 text-sm font-semibold  tracking-wide block mb-1.5">Gate Pass No</label>
              ...
              <div>
                <label className="text-gray-700 text-sm font-semibold  tracking-wide block mb-1.5">Customer Name</label>
              ...
              <div>
                <label className="text-gray-700 text-sm font-semibold  tracking-wide block mb-1.5">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                <label className="text-gray-700 text-sm font-semibold  tracking-wide block mb-1.5">Show Rate</label>
              ...
              <div>
                <label className="text-gray-700 text-sm font-semibold  tracking-wide block mb-1.5">Return</label>
                <select className="w-full bg-emerald-50 border border-emerald-100 focus:border-emerald-400 focus:bg-white rounded-xl px-3 py-2.5 text-gray-700 text-sm focus:outline-none transition-all appearance-none cursor-pointer">
                  <option>Select Return Type</option>
                  <option>Customer Return</option>
                  <option>WareHouse Return</option>
                </select>
              </div>
              <div>
                <label className="text-gray-700 text-sm font-semibold  tracking-wide block mb-1.5">Previous Amount</label>
          ...
          <div className="bg-white border border-emerald-100 rounded-2xl shadow-sm overflow-hidden flex flex-col flex-1">
            ...
            <div className="px-5 py-3 border-b border-emerald-100 flex items-center gap-2 bg-emerald-50/50 shrink-0">
              ...
              <span className="text-gray-700 text-sm font-semibold">Return Items</span>
