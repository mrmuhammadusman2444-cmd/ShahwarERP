                    ...
                    <table className="w-full h-97 text-sm border-collapse">
                        <thead>
                            <tr className="bg-linear-to-b from-emerald-500 to-emerald-700 text-white">
                                ...
                                <th className="text-left text-xs font-semibold px-4 py-3 whitespace-nowrap">Distributor Name</th>
                                ...
                                <th className="text-left text-xs font-semibold px-4 py-3 whitespace-nowrap">Status</th>
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {distributorOrders.length === 0 ? (
                                ...
                                distributorOrders.map((sale, idx) => (
