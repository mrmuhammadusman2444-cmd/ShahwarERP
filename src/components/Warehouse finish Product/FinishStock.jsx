                    ...
                    <table className="w-full text-sm">
                        <thead>
                            <tr className="bg-linear-to-b from-emerald-500 to-emerald-700 text-white">
                                ...
                                <th className="text-left px-4 py-3 font-semibold text-xs  tracking-wide">Pack</th>
                                <th className="text-left px-4 py-3 font-semibold text-xs  tracking-wide">Product Name</th>
                                <th className="text-left px-4 py-3 font-semibold text-xs  tracking-wide">Carton</th>
                                <th className="text-left px-4 py-3 font-semibold text-xs  tracking-wide">Dozen No</th>
                                <th className="text-left px-4 py-3 font-semibold text-xs  tracking-wide">Amount</th>
                            ...
                            <tr>
                                <td colSpan={7} className="py-20 text-center">
                                    <div className="flex flex-col items-center gap-3 ml-15 mt-6">
                                        ...
                                        <p className="text-gray-400 text-xs">Click new finish stock</p>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
