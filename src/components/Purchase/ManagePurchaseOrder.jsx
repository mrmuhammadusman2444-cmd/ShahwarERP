   ...
   <div className="min-h-screen bg-linear-to-br from-blue-50 via-white to-blue-50 p-4 md:p-6">
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-gray-800 text-xl font-bold">Manage Purchase Order</h1>
                        <p className="text-gray-400 text-xs">Manage your Purchase Orders</p>
                    </div>
                </div>
                                ...
                                <tr>
                                    <td colSpan={7} className="text-center py-16">
                                        <div className="flex flex-col items-center gap-2 ml-25">
                                            ...
                                            <p className="text-gray-300 text-xs">Add a new purchase Order to get started</p>
                                        </div>
                                    </td>
                                </tr>
                            ) : (
