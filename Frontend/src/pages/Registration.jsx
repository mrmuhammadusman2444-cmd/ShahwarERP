import { BarChart2, Package, ShieldCheck, Store, } from "lucide-react";
...
const Registration = () => {
  ...
  async function handleRegister() {
    ...
    try {
      let res = await axios.post('http://localhost:3000/signup', RegisterForm)
      toast.success('Registration Successful!', { position: 'bottom-right', autoClose: 800 })
      setTimeout(function () {
        navigate('/login')
      }, 800)
      ...
      >
        ...
        <div className="bg-white p-10 flex flex-col justify-center">
          ...
          <button onClick={handleRegister}
            type="button"
            className="w-full h-10.5 bg-blue-900 hover:bg-blue-800 text-white rounded-lg text-[14px] mt-10 font-medium cursor-pointer mb-3 transition-colors border-none"
          >
            Create account
          </button>
          ...
          <p className="text-[12px] text-slate-400 text-center">
            ...
            <a onClick={() => navigate('/login')} className="text-blue-500 cursor-pointer font-medium">Sign in</a>
          </p>
