...
const AddPurchase = () => {
    ...
    const updateRow = (id, field, value) => {
        setRows(prev => prev.map(row => {
            ...
            const discPercent = Number(updated.dis) || 0
        ...
        <UserPlus className="w-4 h-4 text-white" />
                ...
                <div className="bg-white rounded-xl border border-slate-100 h-134 shadow-sm overflow-hidden">
                    <div className="flex items-center justify-between gap-3 px-4 py-3  border-b border-emerald-100 bg-linear-to-r from-emerald-50 via-white to-emerald-50 rounded-t-xl">
                        ...
                        <div className="flex items-center gap-2">
                            <div className="hidden sm:flex items-center gap-1.5 rounded-lg bg-white border border-emerald-100 px-2.5 py-1.5 shadow-sm">
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-linear-to-b from-emerald-600 to-emerald-700 text-white">
                                    ...
                                    <th className="text-[12px] font-bold px-3 py-2.5 text-center whitespace-nowrap">Stock</th>
                            ...
                            <tbody>
                                {rows.map((row) => (
                                    <tr key={row.id} className="group border-b border-emerald-50 hover:bg-emerald-50/40 transition-colors">

                                        <td className="px-2.5 py-2.5 relative overflow-visible">
                                            <SelectProducts
                                                value={row.product}
                                        ...
                                        <td className="px-2 py-2.5">
                                            <input type="text" inputMode="numeric" placeholder="0"
                                                value={row.invQty}
                                                onChange={(e) => updateRow(row.id, 'invQty', e.target.value)}
                                        ...
                                        <td className="px-2 py-2.5">
                                            <input type="text" inputMode="numeric" placeholder="0"
                                                value={row.stkQty}
                                                onChange={(e) => updateRow(row.id, 'stkQty', e.target.value)}
                                        ...
                                        <td className="px-2 py-2.5">
                                            <div className="relative">
                                                <input type="text" inputMode="numeric" placeholder="0"
                                                    value={row.dis}
                                                    onChange={(e) => updateRow(row.id, 'dis', e.target.value)}
