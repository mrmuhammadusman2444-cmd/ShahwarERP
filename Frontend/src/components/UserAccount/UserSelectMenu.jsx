        ...
        <div className="absolute top-4 right-4 sm:right-6 md:right-8 lg:right-10 xl:right-12 2xl:right-14 z-50">
            ...
            >
                <div className="flex items-center gap-3 px-4 py-3 border-b border-slate-100 bg-slate-50">
                    <div className="w-10 h-10 rounded-full bg-emerald-500 flex items-center justify-center text-white text-[14px] font-semibold ring-2 ring-white shadow-sm overflow-hidden">
                        {user.image ? (
                            <img src={`http://localhost:3000${user.image}`} alt="profile" loading="eager" className="w-full h-full object-cover" />
                        ) : (
                            initials
                        )}
                    </div>
