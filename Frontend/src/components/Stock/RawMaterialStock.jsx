        ...
        <header className="overflow-hidden rounded-3xl border border-slate-200/80 bg-white shadow-sm shadow-slate-200/60">
          ...
          <div className="flex flex-col gap-5 p-6 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-semibold tracking-tight text-slate-900">All Raw Product</h1>
                <p className="mt-0.5 text-sm text-slate-500">Complete raw material stock record</p>
              </div>
            </div>
        ...
        <section className="overflow-hidden rounded-3xl border border-slate-200/80 bg-white shadow-sm shadow-slate-200/60">
          <div className="flex flex-col gap-4 border-b border-slate-100 p-5 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="relative w-full lg:w-72">
              <svg className="pointer-events-none absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round">
              ...
              <tbody className="divide-y divide-slate-100">
                ...
                <tr>
                  <td colSpan={6} className="px-6 py-16 text-center">
                    ...
                    <p className="mt-3 font-medium text-slate-700">No raw products yet</p>
...
function Th({ children, sortable, className = "" }) {
  return (
    <th className={`px-4 py-4 font-semibold ${sortable ? "cursor-pointer select-none hover:text-slate-50" : ""} ${className}`}>
