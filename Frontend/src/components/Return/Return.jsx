  ...
  return (
    <div className="bg-linear-to-br from-emerald-50 via-white to-emerald-50 p-4 md:p-5">
      ...
      <div className="flex gap-1 mb-5 bg-white border border-emerald-100 shadow-sm p-1 rounded-xl w-fit">
        ...
        <button onClick={() => { navigate('/managereturnpage') }} className="px-6 py-2 rounded-lg cursor-pointer text-emerald-500 text-sm font-medium hover:bg-emerald-100 transition-all">
          Manage Returns
        </button>
      </div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-4">
          ...
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 xl:grid-cols-5 gap-3">
            ...
            <div>
              ...
              <select className="w-full bg-emerald-50/70 border border-emerald-100 focus:border-emerald-400 focus:bg-white focus:ring-4 focus:ring-emerald-50 rounded-xl px-3 py-2.5 text-gray-700 text-sm focus:outline-none transition-all appearance-none cursor-pointer">
