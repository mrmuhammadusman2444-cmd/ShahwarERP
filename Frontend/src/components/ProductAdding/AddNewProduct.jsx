      ...
      <div className="bg-white border border-blue-100 rounded-2xl shadow-sm p-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-x-10 gap-y-6 mb-8 pb-8 border-b border-blue-50">
          ...
          <div className="flex items-center gap-2 mb-4  w-40">
            ...
            <select className="w-140 bg-emerald-50 border border-emerald-100 absolute mt-20  focus:border-emerald-400 focus:bg-white rounded-xl px-3 py-2.5 text-gray-700 text-sm focus:outline-none transition-all appearance-none cursor-pointer">
              <option value="">Select category</option>
        ...
        <div className="flex flex-col xl:flex-row gap-6 items-end ">
          ...
          <div className="relative w-72 h-28 rounded-xl border-2 border-dashed border-emerald-200 hover:border-emerald-400 bg-emerald-50/40 hover:bg-emerald-50 transition-all cursor-pointer flex flex-row items-center justify-center gap-4">
          ...
          <div className="w-full xl:w-48 shrink-0 flex flex-col gap-3">
            ...
            <button className="flex items-center cursor-pointer gap-2 justify-center h-12 w-40 ml-170  px-4 py-2.5 bg-linear-to-r from-emerald-600 to-emerald-700 hover:from-emerald-500 hover:to-emerald-600 text-white text-sm font-semibold rounded-xl shadow-md shadow-emerald-200 transition-all hover:-translate-y-0.5">
