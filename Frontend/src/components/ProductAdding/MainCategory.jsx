        ...
        <div className="p-4 md:p-5">
          
          {
            ...
            <div className="flex flex-wrap gap-2 mb-4">
                ...
                <button onClick={()=>{setShowPopup(true)}}  className="flex items-center cursor-pointer gap-2 px-4 py-2 bg-white hover:bg-blue-50 border border-blue-200 text-blue-700 text-sm font-semibold rounded-xl transition-all hover:-translate-y-0.5">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
