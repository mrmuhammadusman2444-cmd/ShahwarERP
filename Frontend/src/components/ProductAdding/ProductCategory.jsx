...
const ProductCategory = () => {
    ...
    useEffect(() => { handleFindCategory() }, [])

    async function handleDeleteCategory(id) {

        let res = await axios.post('http://localhost:3000/delete/category', { _id: id })
    ...
    return (
        <div className="p-4 md:p-5">
            ...
            <div className="bg-white border border-emerald-100 rounded-2xl shadow-sm overflow-hidden">
                ...
                <div className="overflow-x-auto overflow-y-auto custom-scrollbar h-113 rounded-lg border border-emerald-100">
