...
const [categoryPopup, setCategoryPopup]=useState(false)
    ...
    return (
        ...
        <div className="p-4 md:p-5">
            ...
            ? <ProductCategoyPopup setCategoryPopup={setCategoryPopup} />:null
            ...
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-gray-800 text-lg font-bold">Product</h1>
            ...
            <div className="flex flex-wrap gap-2 mb-4">
                ...
                <button onClick={()=>{setCategoryPopup(true)}} className="flex items-center cursor-pointer gap-2 px-4 py-2 bg-white hover:bg-emerald-50 border border-emerald-200 text-emerald-700 text-sm font-semibold rounded-xl transition-all hover:-translate-y-0.5">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <tr>
                                    <td colSpan={2} className="text-center py-16">
                                        <div className="flex flex-col items-center gap-2">
                                            ...
                                            <p className="text-gray-400 text-sm">No Category Found</p>
                                            <p className="text-gray-300 text-xs">Add Some Category</p>
                                        </div>
                                    </td>
                                </tr>
                            ) : (
