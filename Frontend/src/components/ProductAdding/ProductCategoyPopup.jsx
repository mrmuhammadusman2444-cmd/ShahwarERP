        ...
        <div className="bg-white rounded-2xl shadow-xl border border-emerald-100 w-full max-w-xl">
          ...
          <div className="p-5 flex flex-col gap-4">
            ...
            <div>
              ...
              <select className="w-full bg-emerald-50 border border-emerald-100 focus:border-emerald-400 focus:bg-white rounded-xl px-3.5 py-2.5 text-gray-700 text-sm focus:outline-none transition-all appearance-none cursor-pointer">
