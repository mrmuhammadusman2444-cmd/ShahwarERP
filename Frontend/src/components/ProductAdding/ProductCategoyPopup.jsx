...
const ProductCategoyPopup = ({setCategoryPopup}) => {
 return (
    <>
      {/* ── Backdrop ── */}
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-blue-100 w-full max-w-xl">
          ...
          <div className="flex items-center justify-between px-5 py-4 border-b border-blue-50">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center shadow-md shadow-blue-200">
          ...
          <div className="p-5 flex flex-col gap-4">
            ...
            <div>
              ...
              <select className="w-full bg-blue-50 border border-blue-100 focus:border-blue-400 focus:bg-white rounded-xl px-3.5 py-2.5 text-gray-700 text-sm focus:outline-none transition-all appearance-none cursor-pointer">
          ...
          <div className="flex items-center justify-end gap-3 px-5 py-4 border-t border-blue-50">
            ...
            <button
              type="button"
              className="cursor-pointer px-6 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white text-sm font-semibold rounded-xl shadow-md shadow-blue-200 transition-all hover:-translate-y-0.5 active:translate-y-0">
              Save Category
            </button>
          </div>
