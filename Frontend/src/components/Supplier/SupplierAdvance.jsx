...
import {
  Wallet, Building2, Calendar, Tag, Banknote, Info, FileText
} from 'lucide-react';
...
function IconField({ icon: Icon, children }) {
  return (
    <div className="relative group">
      <Icon className="w-3.5 h-3.5 text-emerald-400 group-focus-within:text-emerald-600 absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none transition-colors" />
      {children}
    </div>
  );
}
...
function SectionLabel({ children }) {
  return (
    <div className="flex items-center gap-1.5 mb-3.5">
      <span className="w-1 h-3.5 bg-linear-to-b from-emerald-500 to-emerald-700 rounded-full" />
  ...
  return (
    <div className="p-4 bg-slate-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3.5 items-start">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-slate-200/70 shadow-sm p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
              <div>
                ...
                <IconField icon={Calendar}>
                  <input type="date" className={`${inputClass} cursor-pointer`} />
                </IconField>
              </div>
              <div>
          ...
          <div className="flex flex-col gap-3.5 mb-4">
            ...
            <div className="flex items-center gap-2 bg-emerald-50/60 border border-emerald-100 rounded-lg px-3 py-2.5">
              ...
              <span className="text-[11px] text-slate-500 shrink-0">Amount in word:</span>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="bg-white rounded-xl border border-slate-200/70 shadow-sm p-4 flex flex-col items-center text-center">
            <div className="w-11 h-11 rounded-xl bg-linear-to-br from-emerald-100 to-emerald-200 flex items-center justify-center mb-2">
            ...
            <div className="w-full border-t border-slate-100 pt-3 flex flex-col gap-2">
              ...
              <div className="flex items-center justify-between text-[11px] pt-2 border-t border-slate-100">
                ...
                <span className="text-emerald-700 font-bold tabular-nums">Rs. 0.00</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200/70 shadow-sm p-3.5">
            ...
            <button
              type="button"
              className="w-full py-2.5 border border-emerald-200 text-emerald-600 text-[12.5px] font-semibold rounded-lg hover:bg-emerald-50 cursor-pointer transition-all hover:-translate-y-0.5 active:translate-y-0"
            >
              Save &amp; Another
            </button>
          </div>
