...
const inputClass =
  "w-full text-[12.5px] text-slate-900 placeholder-slate-400 bg-indigo-50/70 border border-indigo-100/70 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-400 transition-all";
    ...
    <div className="p-4 bg-slate-50 min-h-screen">
      ...
      <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-4 mb-3.5">
        ...
        <div className="flex justify-end gap-2.5 pt-3 border-t border-slate-100">
          <button onClick={()=>window.print} className="flex items-center gap-1.5 border cursor-pointer border-blue-200 text-blue-600 rounded-lg px-4 py-2 text-[12px] font-semibold hover:bg-blue-50 transition-colors">
            <Printer className="w-3.5 h-3.5" />
            Print
          </button>
          <button className="flex items-center gap-1.5 bg-blue-600 cursor-pointer text-white rounded-lg px-4 py-2 text-[12px] font-semibold hover:bg-blue-700 transition-colors">
