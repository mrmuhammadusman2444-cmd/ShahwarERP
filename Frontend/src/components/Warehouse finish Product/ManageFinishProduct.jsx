          ...
          <table className="w-full h-97 text-sm border-collapse">
            <thead>
              <tr className="bg-linear-to-b from-emerald-500 to-emerald-700 text-white">
                ...
                <th className="text-left text-xs font-semibold px-4 py-3 whitespace-nowrap">Finish No</th>
                <th className="text-left text-xs font-semibold px-4 py-3 whitespace-nowrap">Sale By</th>
                <th className="text-left text-xs font-semibold px-4 py-3 whitespace-nowrap">Employee Name</th>
            ...
            <tbody className="divide-y divide-gray-100">
              {FinishOrders.length === 0 ? (
                ...
                FinishOrders.map((Product, idx) => (
                  <tr key={Product.id} className={`hover:bg-blue-50/40 transition-colors ${idx % 2 === 0 ? "bg-white" : "bg-gray-50/30"}`}>
                    <td className="px-4 py-3 text-gray-400 text-xs">{idx + 1}</td>
                    <td className="px-4 py-3 text-blue-600 text-xs font-medium">{Product.invoiceNo}</td>
                    <td className="px-4 py-3 text-blue-500 text-xs">{Product.saleBy}</td>
                    <td className="px-4 py-3 text-blue-500 text-xs">{Product.customerName}</td>
                    <td className="px-4 py-3 text-gray-600 text-xs whitespace-nowrap">{Product.date}</td>
                    <td className="px-4 py-3 text-gray-700 text-xs font-medium">{Product.totalAmount}</td>
