                ...
                <div className="flex-1 min-w-0 flex flex-col gap-3">
                    ...
                    <div className="bg-white border border-blue-100 rounded-2xl shadow-sm p-5">
                        ...
                        <div className="flex items-center gap-3 mb-5">
                            ...
                            <div>
                                <h2 className="text-gray-800 text-sm font-semibold">Product Details</h2>
                                <p className="text-gray-400 text-xs">Fill in the information below</p>
                            </div>
                        </div>
                        <div className="grid grid-cols-3 gap-3 mb-4">
                            <div>
                                <label className="text-gray-700 text-sm   tracking-wide block mb-1.5">Product Id</label>
                            ...
                            <div>
                                <label className="text-gray-700 text-sm  tracking-wide block mb-1.5">Employee Name</label>
                            ...
                            <div>
                                <label className="text-gray-700 text-sm  tracking-wide block mb-1.5">
                    ...
                    <div className="bg-white border border-emerald-100 rounded-2xl shadow-sm overflow-hidden flex flex-col flex-1">
                        ...
                        <div className="px-5 py-3 border-b border-emerald-100 flex items-center gap-2 bg-emerald-50/50 shrink-0">
                            ...
                            <span className="text-gray-700 text-sm font-semibold">Product Items</span>
                            <span className="bg-emerald-100 text-emerald-600 text-xs font-bold px-2 py-0.5 rounded-full">
                                {selectedItems.length}
                            </span>
                        </div>

                        <div className="overflow-y-auto custom-scroll h-200" style={{ maxHeight: "260px" }}>
