...
const DateWiseReportPopup = ({showPopup, setShowPopup}) => {
   return (
        <div className="fixed inset-0 bg-slate-900/40 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-xl shadow-xl w-full max-w-xl overflow-hidden">

                <div className="flex items-center justify-between px-4 py-3 bg-slate-50 border-b border-slate-100">
                    <p className="text-[14px] font-bold text-slate-700">Date Wise Attendance Report</p>
                    <button onClick={()=>{setShowPopup(false)}} type="button" className="w-7 h-7 rounded-lg flex items-center justify-center text-slate-400 hover:bg-slate-200 hover:text-slate-600 transition-colors cursor-pointer">
                        <X className="w-4 h-4" />
                    </button>
                </div>
                ...
                <div className="p-4">
                    ...
                    <div className="flex items-center gap-2 mb-4 pb-2.5 border-b border-emerald-100">
                        ...
                        <p className="text-[13px] font-bold text-slate-700">Attendance Report</p>
                    </div>
...
export default DateWiseReportPopup
