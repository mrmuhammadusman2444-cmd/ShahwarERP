  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-white to-blue-50 p-4 md:p-5">
      ...
      <div className="flex gap-1 mb-5 bg-white border border-blue-100 shadow-sm p-1 rounded-xl w-fit">
        ...
        <button onClick={() => { navigate('/ManageOrdersPage') }} className="px-6 py-2 rounded-lg cursor-pointer text-blue-500 text-sm font-medium hover:bg-blue-50 transition-all">
          Manage Orders
        </button>
      </div>
      ...
      <div className="flex flex-col xl:flex-row gap-4">
        ...
        <div className="w-full xl:w-[55%] shrink-0 flex flex-col gap-3">
          ...
          <div className="bg-white border border-blue-100 rounded-2xl shadow-sm p-4 flex flex-col flex-1">
            ...
            <div className="grid grid-cols-3 gap-3 overflow-y-auto flex-1 max-h-[62vh] pr-1 custom-scroll">
              {products.map((p) => (
                <div
                  key={p.id}
                  className="group bg-white hover:bg-blue-50 border border-blue-100 hover:border-blue-300 rounded-xl p-3 cursor-pointer transition-all duration-200 hover:shadow-md hover:shadow-blue-100 hover:-translate-y-0.5 h-fit"
                >
                  <div className="w-full aspect-square rounded-xl bg-blue-50 border border-blue-100 flex items-center justify-center mb-2.5">
                    <svg className="w-8 h-8 text-blue-300 group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex-1 min-w-0 flex flex-col gap-3">
          ...
          <div className="bg-white border border-blue-100 rounded-2xl shadow-sm overflow-hidden flex flex-col flex-1">
            ...
            <div className="px-5 py-3 border-b border-blue-100 flex items-center gap-2 bg-blue-50/50 shrink-0">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 px-5 py-4 border-t border-blue-100 bg-blue-50/40 shrink-0 mt-auto">
              <div>
              ...
              <button className="w-full sm:w-auto px-8 py-2.5 bg-linear-to-r cursor-pointer from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white text-sm font-semibold rounded-xl shadow-md shadow-blue-200 transition-all hover:-translate-y-0.5 active:translate-y-0 whitespace-nowrap">
                Proceed to Order →
              </button>
            </div>
